...
- **Live product validation** — real-time ✅/❌ checks for Transport, Stacker, and Narrow-Aisle robot types against aisle width, load weight, stacking height, and pallet type
...
- **Resource library** — layout specs, technical references, and system requirements (coming soon)
...
product_validators.py   Transport / Stacker / Narrow-Aisle validation rules
